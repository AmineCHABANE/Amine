...
const APIS = [
  ...
  { id:'email', name:'Email Verify', icon:'📧', method:'GET', ep:'/api/email-verify', desc:'Syntax, MX records, disposable detection', live:false,
    req:`curl "https://api-amine.vercel.app/api/email-verify?email=test@gmail.com" \\\n  -H "x-api-key: YOUR_KEY"`,
    res:`{\n  "valid": true,\n  "mx_found": true,\n  "disposable": false\n}` },
  { id:'currency', name:'Currency', icon:'💱', method:'GET', ep:'/api/currency', desc:'170+ fiat & 50+ crypto rates', live:false,
    req:`curl "https://api-amine.vercel.app/api/currency?from=EUR&to=USD&amount=100" \\\n  -H "x-api-key: YOUR_KEY"`,
    res:`{\n  "from": "EUR", "to": "USD",\n  "rate": 1.0847, "result": 108.47\n}` },
  { id:'qr', name:'QR Code', icon:'📱', method:'GET', ep:'/api/qrcode', desc:'Custom colors, sizes & logos', live:false,
    req:`curl "https://api-amine.vercel.app/api/qrcode?data=hello&size=300" \\\n  -H "x-api-key: YOUR_KEY"`,
    res:`// Returns PNG image\n// Content-Type: image/png` },
  { id:'ip', name:'IP Geo', icon:'🌍', method:'GET', ep:'/api/ip-geo', desc:'IP → location, VPN detection', live:false,
    req:`curl "https://api-amine.vercel.app/api/ip-geo?ip=8.8.8.8" \\\n  -H "x-api-key: YOUR_KEY"`,
    res:`{\n  "ip": "8.8.8.8",\n  "country": "US",\n  "city": "Mountain View"\n}` },
  { id:'url', name:'URL Short', icon:'🔗', method:'POST', ep:'/api/shorten', desc:'Shorten + click analytics', live:false,
    ...
    <div style={{ position:'relative', zIndex:1 }}>
      ...
      <section style={{ padding:'52px 20px 44px', maxWidth:600, margin:'0 auto', textAlign:'center' }}>
        ...
        <p className="fi d2" style={{ color:'var(--t2)', fontSize:'clamp(14px,3.5vw,15px)', maxWidth:420, margin:'0 auto 28px', lineHeight:1.65 }}>
          AI Chat, Email Verify, Currency, QR Codes, IP Geo — one fast REST API with a generous free tier.
        </p>
